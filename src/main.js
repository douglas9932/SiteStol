...
ReactDOM.createRoot(document.getElementById('root')).render(_jsx(ErrorBoundary, { children: _jsx(BrowserRouter, { children: _jsx(ContentProvider, { children: _jsx(AppRouter, {}) }) }) }));
